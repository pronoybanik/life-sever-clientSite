    ...
    <div>
      <nav className="lg:mx-80 mt-6">
        <ul className="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-2 border-b border-gray-100">
          <li className="flex-1">
            <Link
              onClick={() => setBorder("BookAppointment")}
              to="/doctorDashBoard/patientAppointment"
              className="relative block p-4"
            >
              <span
                className={`absolute inset-x-0 -bottom-px h-px w-full ${
                  border === "BookAppointment" ? "bg-pink-600" : "bg-slate-50"
                }`}
              ></span>
          ...
          <li className="flex-1">
            <Link
              onClick={() => setBorder("PatientList")}
              to="/doctorDashBoard/patientList"
              className="relative block p-4"
            >
              <span
                className={`absolute inset-x-0 -bottom-px h-px w-full ${
                  border === "PatientList" ? "bg-pink-600" : "bg-slate-50"
                }`}
              ></span>
              <div className="flex items-center justify-center gap-4">
                <svg
