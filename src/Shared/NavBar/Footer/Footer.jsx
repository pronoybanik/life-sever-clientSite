    ...
    return (
        <div className='mt-10'>
            <footer aria-label="Site Footer" className="bg-slate-900 text-white">
                <div
                    className=" px-4 py-16 mx-auto space-y-8 sm:px-6 lg:space-y-16 lg:px-8"
                >

                    {/* that button useing to go to top */}

                    {/* <div className="absolute mt-28 mr-20 end-4 top-4 sm:end-6 sm:top-6 lg:end-8 lg:top-8">
                        <a
                    ...
                    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                        ...
                        <div>
                            <div className="text-teal-600">
                                <Link to="/">
                                    <img src={siteLogo} className='w-40 -mt-6' alt="" />
                                </Link>
                            </div>
                    ...
                    <p className="text-xs text-gray-500 uppercase">
                        &copy; 2022. hospital name: life sever.
                    </p>
                </div>
            </footer>
