...
const AboutUs = () => {
  ...
  return (
    <section>
      <ul>
        <button value="home" onClick={(e) => setTest(e.target.value)}>
          home
        </button>
        <li value="home 1" onClick={(e) => setTest(e.target.value)}>
          home 1
        </li>
        <li value="home 2" onClick={(e) => setTest(e.target.value)}>
          home 2
        </li>
      </ul>

      <div className="relative h-96 bg-[url(https://images.unsplash.com/photo-1604014237800-1c9102c219da?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1770&q=80)] bg-cover bg-center bg-no-repeat">
