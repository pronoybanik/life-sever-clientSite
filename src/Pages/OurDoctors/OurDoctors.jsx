...
const sortOptions = [
  ...
  { name: "Price: Low to High", value: "sort=PerHourCharge", current: false },
  { name: "Price: High to Low", value: "sort=-PerHourCharge", current: false },
];
const subCategories = [
  { name: "Totes", href: "#" },
  { name: "Backpacks", href: "#" },
  ...
  return (
    <div>
      ...
      <div className="bg-white">
        <section
          className="relative lg:h-[400px]  bg-cover bg-center bg-no-repeat"
          style={{ backgroundImage: `url(${DoctorsPageBannerImage})` }}
        >
          <div className="absolute inset-0 bg-black/60  sm:from-white/95 sm:to-white/25 ltr:sm:bg-gradient-to-r rtl:sm:bg-gradient-to-l"></div>

          <div className=" relative   px-4 py-32 sm:px-6 lg:flex lg:h-screen lg:items-center lg:px-8">
            <div className="max-w-xl lg:-mt-96 mx-auto text-center ltr:sm:text-left rtl:sm:text-right">
